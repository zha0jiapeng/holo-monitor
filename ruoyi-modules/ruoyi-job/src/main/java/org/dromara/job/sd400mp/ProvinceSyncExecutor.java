...
@Component
@Slf4j
@JobExecutor(name = "ProvinceSyncExecutor")
public class ProvinceSyncExecutor {
    ...
    public ExecuteResult jobExecute(JobArgs jobArgs) {
        ...
        for (Map.Entry<String, Object> stringObjectEntry : entries1) {
            ...
            for (String city : citys) {
                Hierarchy cityy = new Hierarchy();
                cityy.setParentId(hierarchy.getId());
                cityy.setTypeId(29l);
                cityy.setName(city);
                cityy.setCode(null);
                hierarchyService.save(cityy);

                HierarchyPropertyBo hierarchyProperty = new HierarchyPropertyBo();
                hierarchyProperty.setTypePropertyId(65l);
                hierarchyProperty.setPropertyValue(hierarchy.getId()+"");
                hierarchyProperty.setScope(1);
                hierarchyProperty.setHierarchyId(cityy.getId());
